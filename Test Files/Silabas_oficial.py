    ...
    def separar_silabas(self):
        ...
        def separador_silabas(num_caracteres, diccionario,num_letras_agregar):
            if len(segundos_elementos) >= num_caracteres: #Si hay x elementos en la lista
                 numero_como_cadena = "".join(str(segundos_elementos[i]) for i in range(num_caracteres))
                 print(numero_como_cadena,"Hola")
                 codigo_formado = numero_como_cadena
                 if codigo_formado in diccionario:
                    self.silabas.append(primeros_elementos[num_letras_agregar - 1])
                    del segundos_elementos[0:num_letras_agregar]
                    del segundos_elementos[0:num_letras_agregar]
                    return codigo_formado
        ...
        while True:
            ...
            #1 letra 5 caracteres
            if len(segundos_elementos) >= 5 and int(str(segundos_elementos[0]) + str(segundos_elementos[1]) + str(segundos_elementos[2]) + str(segundos_elementos[3]) + str(segundos_elementos[4])) in una_letra_cinco_caracteres:
            ...
            #4 letras 5 Caracteres
            if len(segundos_elementos) >= 5 and int(str(segundos_elementos[0]) + str(segundos_elementos[1]) + str(segundos_elementos[2])+ str(segundos_elementos[3])+ str(segundos_elementos[4])) in cuatro_letras_cinco_caracteres:
            ...
            #2 letras 4 Caracteres
            if len(segundos_elementos) >= 4 and int(str(segundos_elementos[0]) + str(segundos_elementos[1]) + str(segundos_elementos[2]) + str(segundos_elementos[3])) in dos_letras_cuatro_caracteres:
            ...
            #3 letras 4 Carecteres
            if len(segundos_elementos) >= 4 and int(str(segundos_elementos[0]) + str(segundos_elementos[1]) + str(segundos_elementos[2])+ str(segundos_elementos[3])) in tres_letras_cuatro_caracteres:
                self.silabas.append(primeros_elementos[0]+primeros_elementos[1]+primeros_elementos[2])
                del segundos_elementos[0:3]
                del primeros_elementos[0:3]
            ...
            #1 Letra 3 caracteres
            if len(segundos_elementos) >= 3 and int(str(segundos_elementos[0]) + str(segundos_elementos[1]) + str(segundos_elementos[2])) in una_letra_tres_caracteres:
                self.silabas.append(primeros_elementos[0])
                del segundos_elementos[0:1]
                del primeros_elementos[0:1]
            ...
            #2 letras 3 Caracteres
            if len(segundos_elementos) >= 3 and int(str(segundos_elementos[0]) + str(segundos_elementos[1]) + str(segundos_elementos[2])) in dos_letra_tres_caracteres:
                self.silabas.append(primeros_elementos[0] + primeros_elementos[1])
                del primeros_elementos[0:2]
                del segundos_elementos[0:2]
            ...
            #3 letras 3 Caracteres
            if len(segundos_elementos) >= 3 and int(str(segundos_elementos[0]) + str(segundos_elementos[1]) + str(segundos_elementos[2])) in tres_letras_tres_caracteres:
                self.silabas.append(primeros_elementos[0]+primeros_elementos[1]+primeros_elementos[2])
                del segundos_elementos[0:3]
                del primeros_elementos[0:3]
            ...
            #1 letras 2 caracteres
            if len(segundos_elementos) >= 2 and int(str(segundos_elementos[0]) + str(segundos_elementos[1])) in una_letra_dos_caracteres:
                self.silabas.append(primeros_elementos[0])
                del segundos_elementos[0:1]
                del primeros_elementos[0:1]
